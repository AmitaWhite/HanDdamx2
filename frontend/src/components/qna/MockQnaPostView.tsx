...
import { mockQnaAnswers, type MockQnaPost } from "@/mocks/qna";
import { QnaBackLink } from "./QnaBackLink";

interface MockQnaPostViewProps {
	post: MockQnaPost;
}

export function MockQnaPostView({ post }: MockQnaPostViewProps) {
