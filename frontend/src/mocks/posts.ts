...
export const mockPosts: MockPost[] = [
	{
		id: "post-dongjun-1",
		creatorId: "9",
		projectId: "proj-dongjun-stitch",
		stage: "production",
		category: "자수",
		title: "첫 스티치, 실 고르기부터",
		excerpt: "로컬 테스트용 — 이동준의 첫 피드. 면사와 울사 중 어떤 질감이 더 잘 살까요?",
		body: [
			"로컬 테스트용 피드입니다. 이동준 크리에이터 메인에서 보이는 게시물이에요.",
			"구독자 Q&A는 /creators/9/qna 에서 실제 API로 확인할 수 있습니다.",
		],
		imageSeed: "dongjun-feed1",
		isPaid: false,
		likeCount: 12,
		commentCount: 2,
		createdAtLabel: "2026.07.20",
		tags: ["자수"],
	},
	{
		id: "post-dongjun-2",
		...
		category: "자수",
		title: "도안 스케치 공유",
		excerpt: "이번 연작의 기본 도안을 스케치했어요. 피드백 환영합니다.",
		imageSeed: "dongjun-feed2",
		isPaid: true,
		likeCount: 8,
		commentCount: 1,
	...
	},
	{
		id: "post-dongjun-3",
		creatorId: "9",
		projectId: "proj-dongjun-pouch",
		stage: "concept",
		category: "자수",
		title: "미니 파우치 사이즈 고민",
		excerpt: "카드만 넣을지, 이어폰까지 넣을지 사이즈를 고민 중이에요.",
		imageSeed: "dongjun-feed3",
		isPaid: false,
		likeCount: 5,
		commentCount: 0,
		createdAtLabel: "2026.07.15",
		tags: ["자수", "파우치"],
	},
	{
		id: "post-1",
