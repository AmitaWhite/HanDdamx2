...
public enum ChatErrorCode implements ErrorCode {
	...
	CHAT_NOT_PARTICIPANT(HttpStatus.FORBIDDEN, "해당 채팅방의 참여자만 이용할 수 있습니다."),
	CHAT_ROOM_CLOSED(HttpStatus.FORBIDDEN, "종료된 채팅방에서는 메시지를 전송할 수 없습니다."),
	CHAT_MESSAGE_SEND_SUBSCRIPTION_REQUIRED(HttpStatus.FORBIDDEN, "유료 구독이 만료되어 메시지를 전송할 수 없습니다."),
	CHAT_MESSAGE_INVALID(HttpStatus.BAD_REQUEST, "메시지 내용이 올바르지 않습니다.");
