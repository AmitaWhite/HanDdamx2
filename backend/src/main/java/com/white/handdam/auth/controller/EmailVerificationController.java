...
public class EmailVerificationController {
    ...
    @PostMapping
    public ApiResponse<Void> sendVerificationEmail(@Valid @RequestBody EmailVerificationRequest request) {
    ...
    // KSY-005
    @PostMapping("/confirm")
    public ApiResponse<Void> confirmVerificationEmail(@Valid @RequestBody EmailVerificationConfirmRequest request) {
    ...
    // KSY-006
    @PostMapping("/resend")
    public ApiResponse<Void> resendVerificationEmail(@Valid @RequestBody EmailVerificationRequest request) {
